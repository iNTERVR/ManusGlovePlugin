...
// Override from ManusVR Unity Plugin of Manus
//=============================================================================
...
namespace ManusVR.Hands
{
    ...
    public class HandDataManager
    {
        ...
        // ckbang manus sdk dll
        public static IntPtr ManusSession
        {
            get { return session; }
        }
        ...
        {
            if (!HandDataManager.IsInitialised)
            {
                UsePinchFilter = false;
                Initialise(DataStreamType.Apollo);
                ManusSDKDllInit();
            }
        }
        ...
        public static ApolloHandData GetHandData(device_type_t type)
        {
            int playerNumber = 1;
            if (CanGetHandData(playerNumber, type))
            {
                return GetHandData(playerNumber, type);
            }
