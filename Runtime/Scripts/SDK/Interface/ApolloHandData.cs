...
namespace ManusVR.Hands
{
    ...
    public class ApolloHandData
    {
        ...
        {
            Proximal = 0, // The segment closest to the palm of the hand.
        ...
        bool grabStateDown = false;
        bool grabStateUp = false;
        bool grabState = false;
        
        public bool GetGrabStateDown()
        {
            return grabStateDown;
        }
